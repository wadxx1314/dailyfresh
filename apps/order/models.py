...
class OrderInfo(BaseModel):
    ...
    total_price = models.DecimalField(max_digits=10,decimal_places=2,verbose_name='商品的总价')
    transit_pice = models.DecimalField(max_digits=10,decimal_places=2,verbose_name='商品的运费')
    order_status = models.SmallIntegerField(choices = ORDER_STATUS_CHOICES,default=1,verbose_name='订单状态')
    trade_no = models.CharField(max_length=128,verbose_name='支付的编号')
